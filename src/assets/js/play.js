...
const userRobot = { position: 0, charge: MAX_CHARGE, maxCharge: MAX_CHARGE, name: NAME, hasExploded: false, score: 0 };
...
function drawCircle(robotPos) {
    ctx.globalAlpha = 0.8;
    const xPos = Math.floor(robotPos / GRID_HEIGHT);
    const yPos = robotPos % GRID_WIDTH;
    ctx.beginPath();
